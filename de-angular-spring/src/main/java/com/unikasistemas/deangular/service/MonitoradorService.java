...
public class MonitoradorService {
    ...
    public Resource excelDados(){
        ...
        try{
            ...
            FileOutputStream output = new FileOutputStream("C:\\Users\\dev\\Documents\\GitHub\\desafioestagio-angular-spring\\de-angular-spring\\src\\main\\resources\\Monitoradores.xls");
    ...
    public Resource excelDadosId(Long id){
        ...
        try{
            ...
            //imprimindo o arquivo
            FileOutputStream output = new FileOutputStream("C:\\Users\\dev\\Documents\\GitHub\\desafioestagio-angular-spring\\de-angular-spring\\src\\main\\resources\\Monitorador"+monitorador.getId()+".xls");
            workbook.write(output);
            output.close();
            workbook.close();
